...
const translations = {
  es: {
    ...
    hero: {
      ...
      description:
        "Apasionada por crear experiencias digitales excepcionales que combinan diseño intuitivo con código limpio y eficiente.",
    ...
    experience: {
      ...
      jobs: {
        frontend: {
          ...
          description:
            "Desarrollo de aplicaciones web modernas con React, Vue.js y TypeScript. Liderazgo en implementación de mejores prácticas y arquitecturas escalables.",
        },
        uxui: {
          ...
          period: "2020 - 2022",
          description:
            "Diseño de experiencias de usuario para aplicaciones móviles y web. Investigación de usuarios, wireframing, prototipado y testing de usabilidad.",
        },
        education: {
          ...
          period: "2019 - 2020",
          description:
            "Formación intensiva en tecnologías web modernas, metodologías ágiles y principios de experiencia de usuario.",
        },
      },
    },
    ...
    projects: {
      ...
      items: {
        portfolio: {
          ...
          description:
            "Sitio web personal bilingüe con sistema de temas y diseño responsive desarrollado con HTML5, CSS3 y JavaScript vanilla.",
        },
        landing: {
          title: "Landing Page Corporativa",
          description:
            "Página de aterrizaje moderna para empresa tecnológica con animaciones CSS avanzadas y optimización SEO.",
        },
        elearning: {
          title: "Plataforma E-Learning",
          description:
            "Aplicación web para cursos online con panel de administración, sistema de progreso y evaluaciones interactivas.",
        },
      },
    },
  ...
  en: {
    ...
    hero: {
      ...
      title: "Frontend Developer & UX/UI Designer",
      description:
        "Passionate about creating exceptional digital experiences that combine intuitive design with clean and efficient code.",
    ...
    experience: {
      ...
      jobs: {
        frontend: {
          ...
          period: "2022 - Present",
          description:
            "Development of modern web applications with React, Vue.js and TypeScript. Leadership in implementing best practices and scalable architectures.",
        },
        uxui: {
          title: "UX/UI Designer",
          company: "Digital Agency Co.",
          period: "2020 - 2022",
          description:
            "User experience design for mobile and web applications. User research, wireframing, prototyping and usability testing.",
        },
        education: {
          ...
          period: "2019 - 2020",
          description:
            "Intensive training in modern web technologies, agile methodologies and user experience principles.",
        },
      },
    },
    ...
    projects: {
      ...
      items: {
        portfolio: {
          ...
          description:
            "Bilingual personal website with theme system and responsive design developed with HTML5, CSS3 and vanilla JavaScript.",
        },
        landing: {
          title: "Corporate Landing Page",
          description:
            "Modern landing page for tech company with advanced CSS animations and SEO optimization.",
        },
        elearning: {
          title: "E-Learning Platform",
          description:
            "Web application for online courses with admin panel, progress system and interactive assessments.",
        },
      },
    },
...
class I18n {
  ...
  updateSpecificElements() {
    ...
    if (timelineItems.length >= 3) {
      ...
      if (frontendTitle)
        frontendTitle.textContent = this.t("experience.jobs.frontend.title");
      if (frontendCompany)
        frontendCompany.textContent = this.t(
          "experience.jobs.frontend.company"
        );
      if (frontendDate)
        frontendDate.textContent = this.t("experience.jobs.frontend.period");
      if (frontendDesc)
        frontendDesc.textContent = this.t(
          "experience.jobs.frontend.description"
        );
      ...
      if (uxuiTitle)
        uxuiTitle.textContent = this.t("experience.jobs.uxui.title");
      if (uxuiCompany)
        uxuiCompany.textContent = this.t("experience.jobs.uxui.company");
      if (uxuiDate)
        uxuiDate.textContent = this.t("experience.jobs.uxui.period");
      if (uxuiDesc)
        uxuiDesc.textContent = this.t("experience.jobs.uxui.description");
      ...
      if (educationTitle)
        educationTitle.textContent = this.t("experience.jobs.education.title");
      if (educationCompany)
        educationCompany.textContent = this.t(
          "experience.jobs.education.company"
        );
      if (educationDate)
        educationDate.textContent = this.t("experience.jobs.education.period");
      if (educationDesc)
        educationDesc.textContent = this.t(
          "experience.jobs.education.description"
        );
    }
    ...
    if (projectCards.length >= 3) {
      ...
      if (portfolioTitle)
        portfolioTitle.textContent = this.t("projects.items.portfolio.title");
      if (portfolioDesc)
        portfolioDesc.textContent = this.t(
      ...
      if (landingTitle)
        landingTitle.textContent = this.t("projects.items.landing.title");
      if (landingDesc)
        landingDesc.textContent = this.t("projects.items.landing.description");

      // E-learning
      const elearningTitle = projectCards[2].querySelector("h3");
      const elearningDesc = projectCards[2].querySelector("p");
      if (elearningTitle)
        elearningTitle.textContent = this.t("projects.items.elearning.title");
      if (elearningDesc)
        elearningDesc.textContent = this.t(
          "projects.items.elearning.description"
        );
    }
    ...
    if (contactItems.length >= 3) {
      const emailTitle = contactItems[0]
        ? contactItems[0].querySelector("h4")
        : null;
      const linkedinTitle = contactItems[1]
        ? contactItems[1].querySelector("h4")
        : null;
      const locationTitle = contactItems[2]
        ? contactItems[2].querySelector("h4")
        : null;
      const locationValue = contactItems[2]
        ? contactItems[2].querySelector("p")
        : null;

      if (emailTitle) emailTitle.textContent = this.t("contact.info.email");
      if (linkedinTitle)
        linkedinTitle.textContent = this.t("contact.info.linkedin");
      if (locationTitle)
        locationTitle.textContent = this.t("contact.info.location");
      if (locationValue)
    ...
    if (form) {
      ...
      if (subjectLabel)
        subjectLabel.textContent = this.t("contact.form.subject");
      if (messageLabel)
        messageLabel.textContent = this.t("contact.form.message");
    }
    ...
    if (messageTextarea)
      messageTextarea.placeholder = this.t("contact.form.message");
  }
